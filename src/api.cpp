...
extern "C" std::uint64_t calcprime_meissel_count(std::uint64_t from,std::uint64_t to,
                                                 unsigned threads) {
    std::uint64_t sqrt_limit=0;
    if(to>1){
        sqrt_limit=static_cast<std::uint64_t>(
            std::sqrt(static_cast<long double>(to)))+
                    1;
    }
...
extern "C" std::uint64_t calcprime_meissel_count_with_primes(
    std::uint64_t from,
    std::uint64_t to,
...
extern "C" calcprime_segment_config calcprime_choose_segment_config(
    ...
    auto cpp_config=calcprime::choose_segment_config(
        cpp_info,threads,requested_segment_bytes,requested_tile_bytes,range_length);
...
extern "C" calcprime_status calcprime_run_range(const calcprime_range_options *options,
...
extern "C" int calcprime_range_result_nth_prime(const calcprime_range_run_result *result,
...
extern "C" int calcprime_range_result_stats(const calcprime_range_run_result *result,
...
extern "C" int calcprime_range_result_segment(const calcprime_range_run_result *result,
                                              std::size_t index,
...
extern "C" int calcprime_range_result_copy_primes(const calcprime_range_run_result *result,
                                                  std::uint64_t *buffer,
                                                  std::size_t capacity,
