...
/**
 * Runs the command-line interface of calcprimelist using the provided arguments.
 * This exposes the same behaviour as the prime-sieve executable.
 *
 ...
 */
CALCPRIME_API std::uint64_t calcprime_meissel_count(std::uint64_t from,std::uint64_t to,
                                                    unsigned threads);
 ...
 */
CALCPRIME_API std::uint64_t calcprime_meissel_count_with_primes(
    std::uint64_t from,
    std::uint64_t to,
...
CALCPRIME_API calcprime_status calcprime_run_range(const calcprime_range_options *options,
...
CALCPRIME_API int calcprime_range_result_nth_prime(const calcprime_range_run_result *result,
                                                   std::uint64_t *out_value);

CALCPRIME_API int calcprime_range_result_stats(const calcprime_range_run_result *result,
...
CALCPRIME_API int calcprime_range_result_segment(const calcprime_range_run_result *result,
                                                 std::size_t index,
                                                 const std::uint64_t **out_primes,
                                                 std::size_t *out_count);

CALCPRIME_API int calcprime_range_result_copy_primes(const calcprime_range_run_result *result,
                                                     std::uint64_t *buffer,
                                                     std::size_t capacity,
